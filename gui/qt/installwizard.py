...
from electrum_dnotes import Wallet, WalletStorage
from electrum_dnotes.util import UserCancelled, InvalidPassword
from electrum_dnotes.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Electrum DNotes  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon(':icons/electrum-dnotes.png')
        self.show()
        self.raise_()
    ...
    def run_and_get_wallet(self, get_wallet_from_daemon):
        ...
        self.set_layout(vbox, title=_('Electrum DNotes wallet'))
    ...
    def init_network(self, network):
        message = _("Electrum DNotes communicates with remote servers to get "
                  "information about your transactions and addresses. The "
                  "servers all fulfill the same purpose only differing in "
                  "hardware. In most cases you simply want to let Electrum DNotes "
