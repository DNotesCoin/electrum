...
from electrum_dnotes.bitcoin import TYPE_ADDRESS
from electrum_dnotes import WalletStorage, Wallet
from electrum_dnotes_gui.kivy.i18n import _
from electrum_dnotes.paymentrequest import InvoiceStore
from electrum_dnotes.util import profiler, InvalidPassword
from electrum_dnotes.plugins import run_hook
from electrum_dnotes.util import format_satoshis, format_satoshis_plain
...
from electrum_dnotes.util import base_units
...
class ElectrumWindow(App):
    ...
    def on_use_rbf(self, instance, x):
        self.electrum_dnotes_config.set_key('use_rbf', self.use_rbf, False)
    ...
    def on_qr(self, data):
        from electrum_dnotes.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_dnotes.util import format_time
    ...
    @profiler
    def init_ui(self):
        ''' Initialize The Ux part of electrum-dnotes. This function performs the basic
        ...
        self.icon = "icons/electrum-dnotes.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-DNotes', message,
                            app_icon=icon, app_name='Electrum-DNotes')
        except ImportError:
