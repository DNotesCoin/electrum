...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum-dnotes.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum-dnotes"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum-dnotes:externalType",
                '',
                data)
        return extRecord
