...
from electrum_dnotes_gui.kivy.nfc_scanner import NFCBase
...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum_dnotes.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_dnotes"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_dnotes:externalType",
                '',
                data)
        return extRecord
