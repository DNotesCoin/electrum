...
from electrum_dnotes.util import format_satoshis, set_verbosity
from electrum_dnotes.bitcoin import is_address, COIN, TYPE_ADDRESS
...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid DNotes address'))
            return
        try:
