...
class TestWalletKeystoreAddressIntegrityForMainnet(unittest.TestCase):
    ...
    def test_electrum_dnotes_multisig_seed_standard(self, mock_write):
        ...
        # electrum-dnotes seed: ghost into match ivory badge robot record tackle radar elbow traffic loud
    ...
    def test_electrum_dnotes_multisig_seed_segwit(self, mock_write):
        ...
        # electrum-dnotes seed: hedgehog sunset update estate number jungle amount piano friend donate upper wool
