...
from electrum_dnotes_gui.qt.util import *
from electrum_dnotes.i18n import _
from electrum_dnotes.plugins import hook, DeviceMgr
from electrum_dnotes.util import PrintError, UserCancelled, bh2u
from electrum_dnotes.wallet import Wallet, Standard_Wallet
...
PASSPHRASE_HELP = PASSPHRASE_HELP_SHORT + "  " + _(
    "You need to create a separate Electrum DNotes wallet for each passphrase "
    ...
    def request_trezor_init_settings(self, wizard, method, device):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electrum_dnotes.keystore import is_xprv
        ...
        def toggle_passphrase():
            ...
            if currently_enabled:
                msg = _("After disabling passphrases, you can only pair this "
                        "Electrum DNotes wallet if it had an empty passphrase.  "
                        "If its passphrase was not empty, you will need to "
                        "create a new wallet with the install wizard.  You "
                        "can use this wallet again at any time by re-enabling "
                        "passphrases and entering its passphrase.")
            else:
                msg = _("Your current Electrum DNotes wallet can only be used with "
